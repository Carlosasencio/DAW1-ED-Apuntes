...
El disco duro se considera un periferico de E/S (entrada salida)
...
Predictivo: Es planificar, decir lo que va a pasar en un futuro.
...
- Pruebas y refactorización (Volver a escribir el código de forma más legible)
